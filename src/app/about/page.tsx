...
export default async function AboutPage() {
  ...
  const skillsArray = aboutData?.attributes?.skills
    ...
    : ['JavaScript', 'TypeScript', 'React', 'Next.js', 'Node.js', 'Express', 'C#', 'Python', 'Java', 'MySQL', 'PostgreSQL', 'Docker', 'Git', 'Tailwind CSS', 'Strapi']

  const bio = aboutData?.attributes?.bio || 'Full-Stack Developer and Computer Programming & Analysis student at Durham College. Passionate about building clean, functional web applications.'
